...
import generate.base as base


def test_constructor_single_callable_with_callable_args():
    width = 10
    array = base.constructor(width, value=lambda x: x * 2 - 1, args=random)
...
def test_constructor_single_callable_with_args():
    width = 10
    low, high = 0, 5
    array = base.constructor(width, value=randint, args=(low, high))
...
def test_constructor_single_callable_without_args():
    width = 10
    array = base.constructor(width, value=random)
...
def test_constructor_single_uncallable_with_args():
    width = 10
    low, high = 0, 5
    array = base.constructor(width, value=3, args=(low, high))
...
def test_constructor_single_uncallable_without_args():
    width = 10
    array = base.constructor(width, value=3)
...
def test_constructor_double_callable_with_args():
    width, height = 10, 15
    low, high = 0, 5
    array = base.constructor(width, height, value=randint, args=(low, high))
...
def test_constructor_double_callable_without_args():
    width, height = 10, 15
    array = base.constructor(width, height, value=random)
...
def test_constructor_double_uncallable_with_args():
    width, height = 10, 15
    low, high = 0, 5
    array = base.constructor(width, height, value=3, args=(low, high))
...
def test_constructor_double_uncallable_without_args():
    width, height = 10, 15
    array = base.constructor(width, height, value=3)
...
def test_constructor_triple_callable_with_args():
    ...
    low, high = 0, 5
    array = base.constructor(width, height, depth, value=randint, args=(low, high))
...
def test_constructor_double_no_height_callable_with_args():
    width, depth = 10, 20
    low, high = 0, 5
    array = base.constructor(width, depth=depth, value=randint, args=(low, high))
